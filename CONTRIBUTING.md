...
- **Chuỗi UI mới phải đủ 4 ngôn ngữ** (vi/en/zh/ru) trong bảng `$i18n`.
...
UI hiện có tiếng Việt, English, 中文, Русский. Muốn thêm ngôn ngữ mới: thêm một khóa vào bảng `$i18n` với đầy đủ các chuỗi (lấy khóa `en` làm gốc) và cập nhật menu chọn ngôn ngữ.
