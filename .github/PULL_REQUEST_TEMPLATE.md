...
- [ ] Tested **both launch modes**: typing `.\SweepShield.ps1` in a console AND `powershell -File SweepShield.ps1` (they place functions in different scopes — see CONTRIBUTING.md)
